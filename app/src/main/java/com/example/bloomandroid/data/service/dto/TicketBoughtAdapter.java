...
public class TicketBoughtAdapter extends RecyclerView.Adapter<TicketBoughtAdapter.EventViewHolder> {
    ...
    @NonNull @Override public EventViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_view_ticket_cell, viewGroup, false);
        return new EventViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TicketBoughtAdapter.EventViewHolder eventViewHolder, int i) {
    ...
    class EventViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.list_ticket_event_imageView) ImageView backgroundImageView;
        @BindView(R.id.list_ticket_name_textView) TextView titleTextView;
        @BindView(R.id.list_ticket_collectif_name_textView) TextView associationNameTextView;
        @BindView(R.id.list_ticket_date_textView) TextView dateTextView;
